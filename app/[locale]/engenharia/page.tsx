...
export default async function EngineeringPage({ searchParams }: PageProps) {
  ...
  const faq = locale === "en"
    ...
    ? [
        ...
        { q: "Comment intégrer l'IA dans des systèmes de production ?", a: "Considérez l'IA comme un composant du système, pas comme une feature isolée. Traitez les messages de façon asynchrone, enregistrez les données en retour dans la base, implémentez des fallbacks pour quand le LLM est indisponible et surveillez la qualité des réponses. Le point central est la fiabilité — le système doit fonctionner même quand le fournisseur d'IA a des problèmes." },
