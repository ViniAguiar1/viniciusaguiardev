...
export default async function EngineeringPage() {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto px-4 py-12">
      ...
      {/* Section 1: SaaS Architecture — Vox Pet Digital */}
      <section className="mb-12">
        <div className="flex items-center gap-3 mb-5">
          <h2 className="text-xl font-semibold">
            {en ? "SaaS Architecture — Vox Pet Digital" : "Arquitetura SaaS — Vox Pet Digital"}
          </h2>
      ...
      <section className="mb-12">
        <div className="flex items-center gap-3 mb-5">
          <h2 className="text-xl font-semibold">
            {en ? "Multi-tenant Data Isolation" : "Isolamento de dados Multi-tenant"}
          </h2>
          <div className="h-px flex-1 bg-border" />
        </div>
      ...
      <section className="mb-12">
        <div className="flex items-center gap-3 mb-5">
          <h2 className="text-xl font-semibold">
            {en ? "Payments & External Integrations" : "Pagamentos e integrações externas"}
          </h2>
          <div className="h-px flex-1 bg-border" />
        </div>
