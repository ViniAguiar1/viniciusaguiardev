      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {[
            ...
            { title: t(locale, { pt: "Docker para devs frontend", en: "Docker for Frontend Devs", es: "Docker para devs frontend", jp: "フロントエンド開発者のためのDocker" }), desc: t(locale, { pt: "Dockerfile, multi-stage builds, dev/prod", en: "Dockerfile, multi-stage builds, dev/prod", es: "Dockerfile, multi-stage builds, dev/prod", jp: "Dockerfile、マルチステージビルド、dev/prod" }), href: "/posts/docker-for-frontend-devs" },
            { title: t(locale, { pt: "Iniciando no TypeScript", en: "Getting Started with TypeScript", es: "Iniciando en TypeScript", jp: "TypeScript入門" }), desc: t(locale, { pt: "Tipos, interfaces, generics, utility types", en: "Types, interfaces, generics, utility types", es: "Tipos, interfaces, generics, utility types", jp: "型、インターフェース、ジェネリクス、ユーティリティ型" }), href: "/posts/starting-typescript" },
          ].map((post) => (
