...
export default async function NotFound() {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto px-4 py-16 flex flex-col items-center text-center">
      ...
      {/* 404 text */}
      <p className="text-6xl font-bold tracking-tighter text-fg/15 mb-1 select-none">
        404
      </p>
      ...
      <p className="text-sm text-mu mb-8 max-w-sm">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
        ...
        <Link
          ...
          className="px-5 py-2.5 text-sm font-medium border border-line hover:bg-muted transition"
        >
