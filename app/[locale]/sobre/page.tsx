    ...
    <div className="w-full max-w-5xl mx-auto px-4 py-12">
      ...
      <section className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="rounded-lg border border-border bg-card p-6">
          ...
          <ul className="list-disc pl-5 space-y-1 text-sm">
            ...
            <li>
              {t(locale, { pt: "Integrações REST API, autenticação e fluxos de pagamento", en: "REST API integrations, authentication and payment flows", es: "Integraciones REST API, autenticación y flujos de pago", jp: "REST API連携、認証、決済フロー", fr: "Intégrations REST API, authentification et flux de paiement" })}
            </li>
            <li>
      ...
      <section className="mt-8 rounded-lg border border-border bg-card p-6">
        ...
        <ul className="mt-4 list-disc pl-5 space-y-2 text-sm">
          ...
          <li>{t(locale, { pt: "REST APIs, integrações, autenticação e serviços de pagamento", en: "REST APIs, system integrations, authentication and payment services", es: "REST APIs, integraciones, autenticación y servicios de pago", jp: "REST API、連携、認証、決済サービス", fr: "REST APIs, intégrations, authentification et services de paiement" })}</li>
