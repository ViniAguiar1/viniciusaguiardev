...
2. Add the project to the `projects` array in `apps/portfolio/data/projects.ts`
...
4. If no real logo is available, create a placeholder SVG in `apps/portfolio/public/logos/`:
   ```
...
6. Add the category color in `apps/portfolio/components/projects-grid.tsx` `categoryColors` if it's a new category
