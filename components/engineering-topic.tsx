  ...
  return (
    <>
      <button
        ...
        className="w-full border border-border bg-card flex items-center gap-4 p-5 text-left cursor-pointer hover:shadow-md hover:-translate-y-0.5 transition-all"
      >
